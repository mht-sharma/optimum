...
save_dir = "output_whisper_smooth_quant_3_oct"
...
def preprocess_function(examples, processor, tokenizer, max_length):
    ...
    session = ort.InferenceSession(Path(onnx_model_path) / "encoder_model_orig.onnx")
...
calibration_dataset = quantizer.get_calibration_dataset(
    ...
    preprocess_function=partial(
        preprocess_function_padded, processor=processor, tokenizer=tokenizer, max_length=max_length
    ),
    num_samples=128,
